...
local function ParseCombatLogSpellEvent(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8)
    local destGUID, destName, destFlags, spellId, combatSpellName
    -- MoP 5.4.8 format: sourceFlags, sourceRaidFlags, destGUID, destName, destFlags, destRaidFlags, spellId, spellName
    -- MoP GUIDs are hexadecimal strings starting with 0x (e.g. 0xF130123400001234)
    if type(arg3) == "string" and arg3:match("^0x%x+$") then
        destGUID = arg3
        destName = arg4
        destFlags = arg5
        spellId = arg7
        combatSpellName = arg8
    -- WotLK variant A: srcFlags, destGUID, destName, destFlags, spellId, spellName
    elseif type(arg1) == "number" and type(arg2) == "string" and type(arg4) == "number" then
        destGUID = arg2
        destName = arg3
        destFlags = arg4
        spellId = arg6
        combatSpellName = arg7
    -- WotLK variant B / fallback: destGUID, destName, destFlags, spellId, spellName
    else
        destGUID = arg1
        destName = arg2
        destFlags = arg3
