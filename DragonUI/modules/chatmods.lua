...
local function IsDockChromeHovered()
    ...
    if _G.GuildMicroButton and _G.GuildMicroButton:IsMouseOver() then
        return true
    end
    return false
end
...
local function SetPrimaryChatButtonsAlpha(alpha)
    ...
    SetButtonAlpha(_G.GuildMicroButton, alpha)
    ...
    local function SetChatHoverButtonsVisible(i, visible, entry)
        ...
        if i == 1 then
            ...
            SetButtonVisible((entry and entry.friendsBtn) or _G.GuildMicroButton, visible)
        end
    end
...
local function ApplyChatFrameTweaks()
        ...
        if cf then
            ...
            if bf then
                ...
                local entry = {
                    ...
                    friendsBtn = (i == 1) and _G.GuildMicroButton or nil,
                    lastTabAlpha = nil,
                    lastBgAlpha = nil,
    ...
    AttachChatHoverRefreshHooks(_G.GuildMicroButton)
