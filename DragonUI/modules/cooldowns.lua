...
-- ============================================================================
-- COMBAT COOLDOWN RESET SYNC
-- ============================================================================
-- In combat, secure action button cooldowns are updated by the engine (C code),
-- not via Lua SetCooldown, so the metatable hook above does not fire. This
-- means resets like Mage "Cold Snap" clearing Ice Block update the sweep but
-- not our numeric countdown. Listen for the cooldown events (which DO fire in
-- combat) and re-sync the text from GetCooldown().
