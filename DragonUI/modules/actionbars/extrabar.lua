...
-- MoP uses UNIT_POWER/UNIT_MAXPOWER; keep per-school events as fallback for private servers.
local PLAYER_POWER_EVENTS = {
    UNIT_POWER = true,
    UNIT_MAXPOWER = true,
    -- Legacy WotLK aliases
    UNIT_MANA = true,
    UNIT_MAXMANA = true,
    UNIT_ENERGY = true,
    UNIT_MAXENERGY = true,
...
initFrame:RegisterEvent("UNIT_POWER")
initFrame:RegisterEvent("UNIT_MAXPOWER")
initFrame:RegisterEvent("UNIT_MANA")
initFrame:RegisterEvent("UNIT_MAXMANA")
initFrame:RegisterEvent("UNIT_ENERGY")
initFrame:RegisterEvent("UNIT_MAXENERGY")
initFrame:RegisterEvent("UNIT_RAGE")
initFrame:RegisterEvent("UNIT_MAXRAGE")
initFrame:RegisterEvent("UNIT_FOCUS")
initFrame:RegisterEvent("UNIT_MAXFOCUS")
initFrame:RegisterEvent("UNIT_RUNIC_POWER")
initFrame:RegisterEvent("UNIT_MAXRUNIC_POWER")
initFrame:SetScript("OnEvent", function(self, event, arg1)
    ...
    elseif event == "UNIT_INVENTORY_CHANGED" or PLAYER_POWER_EVENTS[event] then
        if arg1 == "player" then
            RequestRefreshAll()
        end
