...
local function UpdateGroupIndicator()
    ...
    local numRaidMembers = addon.GetNumRaidMembers()
...
local function SetupPlayerEvents()
    ...
    f:SetScript("OnEvent", function(_, event, ...)
        ...
        elseif POWER_EVENTS[event] then
            -- In MoP, UNIT_POWER / UNIT_MAXPOWER carry a powerType token.
            if event == "UNIT_POWER" or event == "UNIT_MAXPOWER" then
                if powerType ~= "MANA" and powerType ~= "RAGE"
                   and powerType ~= "FOCUS" and powerType ~= "ENERGY"
                   and powerType ~= "RUNIC_POWER" then
                    return
                end
            end
