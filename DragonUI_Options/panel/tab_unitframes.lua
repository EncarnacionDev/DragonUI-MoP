...
local function BuildToTSection(scroll)
    ...
    if totOverride then
        C:AddDescription(tot, "|cff2dd4bf- " .. LO["Detached — positioned freely via Editor Mode"] .. "|r")
    else
    ...
    if fotOverride then
        C:AddDescription(fot, "|cff2dd4bf- " .. LO["Detached — positioned freely via Editor Mode"] .. "|r")
    else
